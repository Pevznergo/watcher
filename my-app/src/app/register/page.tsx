...
export default function RegisterPage() {
    return (
        <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 relative overflow-hidden">
            <div className="absolute top-0 left-0 w-[50%] h-[50%] bg-violet-600/10 blur-[120px] rounded-full point-events-none" />
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10 border border-slate-700/50">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm">Create your AI monitoring account</p>
                </div>
