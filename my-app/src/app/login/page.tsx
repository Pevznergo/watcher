...
import { signIn } from "@/auth"; // Server-side or client use client logic for Google

export default function LoginPage() {
    return (
        <div className="min-h-screen bg-[#0B0F19] flex items-center justify-center p-4 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-[50%] h-[50%] bg-indigo-600/10 blur-[120px] rounded-full point-events-none" />
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl relative z-10 border border-slate-700/50">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400 text-sm">Welcome back to your AI dashboard</p>
                </div>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-[#1C2333] px-2 text-slate-400">Or continue with</span>
                    </div>
                </div>
                ...
                <form action={async () => {
                    ...
                    <button type="submit" className="w-full bg-white text-slate-900 hover:bg-slate-200 font-medium py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2">
